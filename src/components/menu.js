  ...
  return(
    <div className='Menu container-fluid'>
      ...
      <div className='row'>
        ...
        description = "A classic slice with cheese, sause, and guess what else... that's right pepperoni."
        price = "$1.00"/>
        <Slice
        img = {meat}
        ...
        img = {veggie}
        title = "Veggie Slice"
        description = "You trying to be healthy but still can't resist pizza? Well then the veggie slice is for you! This is guilt-free pizza at its finest."
        price = "$1.00"/>
        <Slice
        img = {hawaiian}
